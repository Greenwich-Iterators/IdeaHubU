	...
	<div class="idea-wrapper">
		...
		<div id="main-submission-guidelines">
			...
			<ul>
				...
				<li>
					<strong>Terms and Conditions:</strong> Before making any submission you will need to accept and agree to our Terms and Conditions. <br>
					You can view our Terms and Conditions by clicking on the below link.
				</li>
			</ul>
			<button id="termsAndConditions-btn" onclick=hideShowTerms()> <span> View our Terms and Conditions here</span></button>
		</div>
				...
				<div class="terms-wrapper">
					<div class="terms-content">
						...
						<ul>
							...
							<li>
								<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to University, Lusaka.</p>
							</li>
							<li>
							...
							<li>
								<p><strong>Website</strong> refers to Concept Hub, accessible from [Concept Hub](Concept Hub)</p>
							</li>
							<li>
